...
Además, la API está documentada mediante Swagger (OpenAPI) para asegurar la claridad y colaboración en entornos profesionales.
...
Ejemplo: registrar una reserva en el Hotel Rosario del 10 al 15 de diciembre de 2025.
GET /api/reservas/
...
PUT /api/reservas/:id
Actualiza los datos de una reserva existente (por ejemplo, cambiar el tipo de habitación o las fechas).
